...
public class TechWoParts extends TestDriverActions {
        ...
        public void gotoTechRo() throws InterruptedException {
            ...
            if(LoginActions.environmentName.contains("EU")){
                loginPage.loginWithValidCredentials(appProp29.getProperty("username"),appProp29.getProperty("password"));
            } else if(LoginActions.environmentName.contains("NA")){
                loginPage.loginWithValidCredentials(appProp45.getProperty("username"),appProp45.getProperty("password"));
