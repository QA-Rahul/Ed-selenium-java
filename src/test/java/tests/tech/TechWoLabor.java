...
public class TechWoLabor extends TestDriverActions {
    ...
    public void gotoTechRo() throws InterruptedException {
        if(LoginActions.environmentName.contains("EC")){
            loginPage.loginWithValidCredentials(appProp15.getProperty("username"),appProp15.getProperty("password"));
        }else if(LoginActions.environmentName.contains("EU")){
            loginPage.loginWithValidCredentials(appProp28.getProperty("username"),appProp28.getProperty("password"));
        }else if(LoginActions.environmentName.contains("NA")){
            loginPage.loginWithValidCredentials(appProp44.getProperty("username"),appProp44.getProperty("password"));
