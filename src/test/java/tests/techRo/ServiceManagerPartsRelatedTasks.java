...
public class ServiceManagerPartsRelatedTasks extends TestDriverActions {
    ...
    public void Test_001_gotoCompleteRo() throws InterruptedException, IOException, FileNotFoundException {
        if(LoginActions.environmentName.contains("EC")){
            loginPage.loginWithValidCredentials(appProp13.getProperty("username"),appProp13.getProperty("password"));
        } else  if(LoginActions.environmentName.contains("EU")){
            loginPage.loginWithValidCredentials(appProp25.getProperty("username"),appProp25.getProperty("password"));
        } else  if(LoginActions.environmentName.contains("NA")){
            loginPage.loginWithValidCredentials(appProp41.getProperty("username"),appProp41.getProperty("password"));
