...
public class ServiceManagerWoLabor extends TestDriverActions {
  ...
  public void gotoCompleteRoScreen() throws FileNotFoundException, InterruptedException {
      if(LoginActions.environmentName.contains("EC")){
          loginPage.loginWithValidCredentials(appProp11.getProperty("username"),appProp11.getProperty("password"));
      }else if(LoginActions.environmentName.contains("EU")){
          loginPage.loginWithValidCredentials(appProp26.getProperty("username"),appProp26.getProperty("password"));
      }else if(LoginActions.environmentName.contains("NA")){
          loginPage.loginWithValidCredentials(appProp43.getProperty("username"),appProp43.getProperty("password"));
