...
public class CreateVendor extends TestDriverActions {
      ...
      public void Test_001_gotoVendorsScreen() throws FileNotFoundException, InterruptedException {
          if(LoginActions.environmentName.contains("EC")){
              loginPage.loginWithValidCredentials(appProp3.getProperty("username"),appProp3.getProperty("password") );
          } else if(LoginActions.environmentName.contains("NA")){
              loginPage.loginWithValidCredentials(appProp34.getProperty("username"),appProp34.getProperty("password") );
