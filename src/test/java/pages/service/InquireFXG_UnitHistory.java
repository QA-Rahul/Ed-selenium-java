...
//         WaitActions.getWaits().waitForElementTobeClickable(label_FedExFleetHistory);
          action.waitForElementToBeRefreshedAndClickable(label_FedExFleetHistory);
         WebElementActions.getActions(driver).clickElement(label_FedExFleetHistory);
 ...
 //           WaitActions.getWaits().WaitUntilWebElementIsVisible(asterisk_unitNum);
          action.waitForElementToBeRefreshedAndIsVisible(asterisk_unitNum);
 ...
 //           WaitActions.getWaits().waitForElementTobeClickable(hyperlink_selectUnit);
          action.waitForElementToBeRefreshedAndClickable(hyperlink_selectUnit);
            WebElementActions.getActions(driver).clickElement(hyperlink_selectUnit);
...
//            Assert.assertTrue(label_SearchUNIT.isDisplayed());
 //           WaitActions.getWaits().WaitUntilWebElementIsVisible(label_result);
          action.waitForElementToBeRefreshedAndIsVisible(label_result);
...
//            WaitActions.getWaits().waitForElementTobeClickable(txt_search);
          action.waitForElementToBeRefreshedAndClickable(txt_search);
            WebElementActions.getActions(driver).inputText(txt_search,prop.getProperty("UnitNumber"));
  //          Thread.sleep(3000);
          action.loadingWait(loder);
            TestListener.saveScreenshotPNG(driver);
      }
...
//              WaitActions.getWaits().waitForElementTobeClickable(btn_select);
            action.waitForElementToBeRefreshedAndClickable(btn_select);
...
//            WaitActions.getWaits().WaitUntilWebElementIsVisible(label_unitNumber2);
 //           Thread.sleep(3000);
          action.waitForElementToBeRefreshedAndIsVisible(label_unitNumber2);
...
//              WaitActions.getWaits().WaitUntilWebElementIsVisible(label_HistorySearch);
            action.waitForElementToBeRefreshedAndIsVisible(label_HistorySearch);
...
//              WaitActions.getWaits().WaitUntilWebElementIsVisible(label_Labour_for);
            action.waitForElementToBeRefreshedAndIsVisible(label_Labour_for);
 ...
 //           WaitActions.getWaits().waitForElementTobeClickable(hyperlink_unitNumber);
          action.waitForElementToBeRefreshedAndClickable(hyperlink_unitNumber);
...
//              WaitActions.getWaits().waitForElementTobeClickable(txt_search);
            action.waitForElementToBeRefreshedAndClickable(txt_search);
              WebElementActions.getActions(driver).inputText(txt_search,prop.getProperty("SearchUnit"));
  //            Thread.sleep(3000);
            action.loadingWait(loder);
              TestListener.saveScreenshotPNG(driver);
        }
 ...
 //           WaitActions.getWaits().waitForElementTobeClickable(btn_search);
  //          Thread.sleep(3000);
          action.waitForElementToBeRefreshedAndClickable(btn_search);
 ...
 //           WaitActions.getWaits().WaitUntilWebElementIsVisible(label_Ro_date);
          action.waitForElementToBeRefreshedAndIsVisible(label_Ro_date);
...
//            WaitActions.getWaits().WaitUntilWebElementIsVisible(label_repairDetails);
          action.waitForElementToBeRefreshedAndIsVisible(label_repairDetails);
            Assert.assertTrue(label_repairDetails.isDisplayed());
//            WaitActions.getWaits().WaitUntilWebElementIsVisible(label_complaunt);
          action.waitForElementToBeRefreshedAndIsVisible(label_complaunt);
...
//            WaitActions.getWaits().WaitUntilWebElementIsVisible(label_parts);
          action.waitForElementToBeRefreshedAndIsVisible(label_parts);
